  ...
  return <div >
    ...
    {modal && <Modal onClose={toggle}>
      <div className='mt-8 mb-8 p-4'>
        ...
        Achja..
        <br />
        ..es ist natürlich möglich, den Counter auf 0 zu bringen.. aber was danach passiert, musst du schon selber rausfinden. 🤫
        <br />
        <br />
        Dieses Spiel haben wir entwickelt, um unseren Teil zur Bewältigung der derzeitige Corona-Krise beizutragen. Mit dieser Web App werden die sonst sehr abstrakten Zahlen, welche derzeit die Schlagzeilen beherrschen, endlich greifbar gemacht.
        <br />
        ...
        Teile Corona-Clicker mit Freunden, Familie und Lieblingsinfluencer, um von höheren Communitybelohnungen zu profitieren! #sharingiscaring #care2win
      </div>
    </Modal>}
  </div>
}
