...
export const CommBarInfoModal = ({}) => {
  return <div className='m-2'>
    <div className='text-center text-teal-600 font-light text-sm p-4'>
        ...
        #füreinander
        <br/>
        Eine weitere Möglichkeit, den Community-Balken schneller wachsen zu lassen, ist natürlich Weitersagen! Teile dieses Projekt mit Familie, Freunden und dem SocialMedia-Kanal deiner Wahl und unterstütze dabei nicht nur deinen Spielfortschritt, sondern auch die Helfer/-innen, die gerade Tag und Nacht Alles dafür geben, um Menschen in Not beizustehen!
        <br/>
        #care2win
      </div>
  </div>
